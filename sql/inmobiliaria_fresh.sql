-- Esquema COMPLETO para Gestión Inmobiliaria alineado al código actual
-- Uso recomendado: importar en una BD nueva (p.ej. gestion_inmobiliaria)
...
-- =============================
-- especialidades (Tipos de Propiedad)
-- =============================
...
CREATE TABLE casos (
    ...
    honorarios_estimados DECIMAL(10,2) DEFAULT 0,  -- Precio Estimado
    honorarios_cobrados DECIMAL(10,2) DEFAULT 0,   -- Señales/Comisiones/Ingresos
    observaciones TEXT,
...
-- =============================
-- servicios_legales (Servicios/Extras)
-- =============================
...
-- =============================
-- servicios_prestados (detalle por propiedad)
-- =============================
...
CREATE TABLE citas (
    id INT AUTO_INCREMENT PRIMARY KEY,
    caso_id INT NULL,                 -- Propiedad visitada
    cliente_id INT NULL,              -- Interesado/comprador
    abogado_id INT NULL,              -- Agente
...
INSERT INTO servicios_legales (nombre, descripcion, precio_base, precio_por_hora) VALUES
('Publicación Premium', 'Destacar en portales', 10000.00, 0),
('Fotografía Profesional', 'Pack de fotos y video', 30000.00, 0);

-- Una visita de ejemplo
INSERT INTO citas (caso_id, cliente_id, abogado_id, titulo, descripcion, fecha_cita, duracion_estimada, tipo, ubicacion, estado) VALUES
(1, 2, 2, 'Visita a propiedad', 'Coordinación con interesado', DATE_ADD(NOW(), INTERVAL 2 DAY), 60, 'visita', 'Palermo, CABA', 'programada');

-- Factura de ejemplo (con detalle)
INSERT INTO facturas (cliente_id, caso_id, numero_factura, fecha_emision, fecha_vencimiento, subtotal, impuestos, total, estado, metodo_pago, observaciones) VALUES
(1, 1, 'FAC-0001', NOW(), DATE_ADD(NOW(), INTERVAL 30 DAY), 100000.00, 21000.00, 121000.00, 'emitida', 'transferencia', 'Señal de compra');

INSERT INTO detalle_facturas (factura_id, servicio_id, descripcion, cantidad, precio_unitario, total) VALUES
